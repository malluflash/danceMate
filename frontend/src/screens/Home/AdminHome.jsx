    ...
    <div className="min-h-screen bg-gradient-purple-pink-vertical pt-24 px-4 sm:px-6 lg:px-8 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <motion.div 
          ...
          className="mb-10"
        >
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 drop-shadow-lg">Welcome, Admin</h1>
          <p className="text-white/90">Manage your dance studio platform from one place</p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="card-gradient text-white h-full rounded-xl p-6 hover:shadow-glow transition-all duration-300">
              ...
              <p className="text-white/80">Schedule new dance classes and manage time slots</p>
            </div>
          </Link>
          ...
          >
            <div className="card-gradient text-white h-full rounded-xl p-6 hover:shadow-glow transition-all duration-300">
              ...
              <p className="text-white/80">Monitor and manage all scheduled dance classes</p>
            </div>
          </Link>
